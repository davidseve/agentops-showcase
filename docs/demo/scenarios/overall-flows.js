...
export const BASELINE_MUTATIONS = [
  ...
  { step: 6, label: `5  ${LAYER_NAMES.nemo} → ${LAYER_NAMES.maas}` },
  { step: 7, label: `6  ${LAYER_NAMES.maas} → Guardrails LLM` },
  { step: 8, label: `7  ${LAYER_NAMES.maas}`, actions: [{ id: "p-path", style: "highlight" }] },
  { step: 9, label: `8  ${LAYER_NAMES.llm}` },
  ...
  { step: 13, label: `9  ${LAYER_NAMES.landlock} →`, actions: [{ id: "l-files", style: "highlight" }] },
  { step: 14, label: `9  ${LAYER_NAMES.landlock} → file` },
  { step: 15, label: `9  ← ${LAYER_NAMES.landlock}` },
  {
    step: 16,
    label: `10  ${LAYER_NAMES.openClaw} → ${LAYER_NAMES.gw}`,
    actions: [{ id: "l-net", style: "highlight" }, { id: "l-gw", style: "highlight" }],
  },
  { step: 17, label: `10  ${LAYER_NAMES.gw} → ${LAYER_NAMES.internet}` },
  { step: 18, label: `10  ${LAYER_NAMES.internet} → ${LAYER_NAMES.gw}` },
  { step: 19, label: `10  ${LAYER_NAMES.gw} → ${LAYER_NAMES.openClaw}` },
  { step: 20, label: `1  ${LAYER_NAMES.openClaw} → ${LAYER_NAMES.gw}` },
  { step: 21, label: `1  ${LAYER_NAMES.gw} → ${LAYER_NAMES.endUser}` },
  { step: 22, label: `11  ${LAYER_NAMES.openClaw} → ${LAYER_NAMES.gw}`, actions: [{ id: "l-mlflow", style: "highlight" }] },
  { step: 23, label: `11  ${LAYER_NAMES.gw} → ${LAYER_NAMES.mlflow}` },
];
...
export const BASELINE_STEPS = [
  ...
  {
    text: `${LAYER_NAMES.nemo} sends to ${LAYER_NAMES.maas} for guardrail evaluation`,
    mode: "arrow",
    from: "nemo",
    to: "maas",
    color: COLORS.nemo,
  ...
  {
    text: `${LAYER_NAMES.landlock} denies file access`,
    mode: "arrow",
    from: "landlock",
    to: "file",
    color: COLORS.landlock,
